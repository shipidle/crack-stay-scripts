...
- BETA의 방별 번역 설정 수동 보관은 [대사 번역 설정 SQL](https://github.com/${config.repository}/blob/beta/supabase/dialogue_translator_sync.sql)을 같은 Supabase 프로젝트에서 1회 실행해야 함.
- BETA의 메신저 방별 설정 동기화는 [메신저 설정 SQL](https://github.com/${config.repository}/blob/beta/supabase/messenger_sync.sql)을 같은 Supabase 프로젝트에서 1회 실행해야 함.
